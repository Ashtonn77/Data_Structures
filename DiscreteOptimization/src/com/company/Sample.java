...
public class Sample {
   ...
   private static int capacity;
    ...
    //take method
    private float takeValue(int idx){
        
        return 0;
    }
    
    
    private float dontTakeValue(int idx){
        
        return 0;
    }
    
    private static float getBound(int w, int v, int idx, Item[] items){
    ...
    private static float solve(Item[] arr){
        ...
        pq.add(new Node(0, 0, getBound(0, 0, 0,  arr)));
